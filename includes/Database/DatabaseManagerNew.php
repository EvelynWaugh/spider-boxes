...
use SpiderBoxes\Database\Repositories\MetaRepository;
...
class DatabaseManager {
	...
	// ========================================
	// Meta Operations (delegated to MetaRepository)
	// ========================================
	...
	public static function save_meta( $object_id, $object_type, $meta_key, $meta_value, $context = 'default' ) {
		return self::get_repository( 'meta' )->save_meta( $object_id, $object_type, $meta_key, $meta_value, $context );
	}
	...
	public static function get_meta( $object_id, $object_type, $meta_key, $context = 'default' ) {
		return self::get_repository( 'meta' )->get_meta( $object_id, $object_type, $meta_key, $context );
	}

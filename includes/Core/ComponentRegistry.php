...
class ComponentRegistry {
	...
	private function register_default_component_types() {
		$default_types = array(
			...
			'pane'      => array(
				'class_name' => 'SpiderBoxes\\Components\\PaneComponent',
				'supports'   => array( 'title', 'description', 'fields', 'collapsed' ),
				'parent'     => 'accordion',
				'category'   => 'layout',
			),
			'tabs'      => array(
				'class_name' => 'SpiderBoxes\\Components\\TabsComponent',
				'supports'   => array( 'title', 'tabs' ),
				'children'   => array( 'tab' ),
				'category'   => 'layout',
			),
			'tab'       => array(
				'class_name' => 'SpiderBoxes\\Components\\TabComponent',
				'supports'   => array( 'title', 'icon', 'fields', 'active' ),
				'parent'     => 'tabs',
				'category'   => 'layout',
			),
			'row'       => array(
				'class_name' => 'SpiderBoxes\\Components\\RowComponent',
				'supports'   => array( 'title', 'columns', 'gap', 'align' ),
				'children'   => array( 'column' ),
				'category'   => 'layout',
			),
			'column'    => array(
				'class_name' => 'SpiderBoxes\\Components\\ColumnComponent',
